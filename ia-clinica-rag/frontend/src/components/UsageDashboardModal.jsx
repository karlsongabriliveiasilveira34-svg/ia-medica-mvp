    ...
    <div className="p-5 rounded-3xl bg-gradient-to-r from-amber-500/10 via-emerald-500/10 to-teal-500/10 border-2 border-dashed border-amber-500/30 space-y-3">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <h4 className="font-editorial text-base font-bold text-[#17231f]">Tem um Cupom de Cortesia ou Teste Beta?</h4>
            <p className="text-[11px] text-[#5e6c65]">Use o cupom <strong>BETA7DIAS</strong> para desbloquear 7 dias de Acesso Total ao Plano Médico!</p>
          </div>
        </div>
      </div>
...
function UsagePlansGrid({ plans, usageData, upgrading, handleSelectUpgrade }) {
  return (
  ...
  return (
    ...
    >
      <div
        role="dialog"
        aria-modal="true"
        className="relative w-full max-w-4xl rounded-3xl bg-white p-6 sm:p-8 shadow-2xl border border-[#17231f]/10 max-h-[90vh] overflow-y-auto space-y-6"
      >
        ...
        <UsagePlansGrid
          ...
          usageData={usageData}
          upgrading={upgrading}
          handleSelectUpgrade={handleSelectUpgrade}
        />
      </div>
    </div>
  );
