  ...
  return (
    ...
    >
      <div
        role="dialog"
        aria-modal="true"
        className="relative w-full max-w-lg rounded-3xl bg-white p-6 sm:p-8 shadow-2xl border border-[#17231f]/10 max-h-[92vh] overflow-y-auto space-y-5 text-[#17231f]"
      >
